...
# Run synthesis
synth_design -top FrameGeneratorTop -part xc7z020clg400-1 -flatten_hierarchy rebuilt
create_clock -period 10.000 -name sys_clk_100mhz -waveform {0.000 5.000} [get_ports frameOut_aclk]
